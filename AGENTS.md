...
Offline, local-only **context migration** across enabled source adapters × enabled destination hosts (currently **14×14=196** cells, **derived from registries** — not a fixed product constant).
