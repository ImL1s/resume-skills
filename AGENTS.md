...
Offline, local-only **context migration** across enabled source adapters × enabled destination hosts (currently **15×16=240** cells, **derived from registries** — not a fixed product constant).
