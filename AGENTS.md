...
Offline, local-only **context migration** across enabled source adapters × enabled destination hosts (currently **16×18=288** cells, **derived from registries** — not a fixed product constant).
