...
Offline, local-only **context migration** across enabled source adapters × enabled destination hosts (currently **15×15=225** cells, **derived from registries** — not a fixed product constant).
