...
| Installed runner matrix | **306/306** on current main tip via **Ubuntu hard gate** (**17×18**, derived from registries); **Windows** focused product-install smoke only (3 hosts) — **not** 306/306 on Windows; published `0.3.4` remains historical **9×9=81** |
