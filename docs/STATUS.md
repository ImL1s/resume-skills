...
| Python test suite | **944 pass locally** at tip `4fb4de2` (2026-08-01 post-batch verification; v0.3.4 tag was 375; historical counts remain release-specific evidence only). |
...
|---|---|---|
| Current local release gates | pass | **944 pass locally** at tip `4fb4de2` + **306/306** registry-derived installed-runner (2026-08-01 post-batch); the Wave 0 snapshot was 426 tests + 81/81 on 2026-07-28 |
