...
| Grok + Antigravity large histories (#15) | [Issue #15](https://github.com/ImL1s/resume-skills/issues/15) | **In progress:** Grok metadata-first list; Antigravity exact-show independent of optional index; stream-reduce without full record retention. Residual: large 17–30 MiB synthetic CI cases may follow; collect-free yield still #10. |
