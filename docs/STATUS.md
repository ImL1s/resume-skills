...
| Windows native (`windows-latest` / real `nt`) | **verified** (read-only) | **fail-closed** (#125 OPEN) | Evidence: [run 30753320460](https://github.com/ImL1s/resume-skills/actions/runs/30753320460); Phase 1 = lock primitive only, not product install |
