...
| Gate | Status |
|---|---|
| Source adapters | 16: Claude, Codex, Cursor, OpenCode, Antigravity, Grok, Qwen, Kimi, Pi, OpenClaw, goose, Crush, Cline, OpenHands, Hermes, **Gemini CLI** |
| Destination profiles | 17 including prior hosts + **GitHub Copilot CLI** (destination-only) + **Gemini CLI** (compat; independent of Antigravity) (filesystem install supported) |
| Packaging matrix | **272/272** on current main tip (**16×17**, derived from registries; published `0.3.4` remains historical **9×9=81**) |
| Installed runner matrix | **272/272** on current main tip (**16×17**, derived from registries; published `0.3.4` remains historical **9×9=81**) |
