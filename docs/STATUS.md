...
| Python test suite | **818 pass locally** in the fresh 2026-07-31 canonical verification (v0.3.4 tag was 375; historical counts remain release-specific evidence only). |
...
|---|---|---|
| Current local release gates | pass | **818 pass locally** + **306/306** registry-derived installed-runner (2026-07-31); the Wave 0 snapshot was 426 tests + 81/81 on 2026-07-28 |
