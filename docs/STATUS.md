...
| Shared `stable_scan_lines` (#10) | [Issue #10](https://github.com/ImL1s/resume-skills/issues/10) + PR #49 | Foundation on main; **adopted by Pi, Kimi, Cursor CLI, Qwen, Grok, Antigravity, Codex plain show**; collect-free verified spool yield on PR #101. Claude private graph retained. Residual: zstd whole-decompress (#8). |
