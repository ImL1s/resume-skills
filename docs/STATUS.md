...
| Owned skill runners (#26) | [Issue #26](https://github.com/ImL1s/resume-skills/issues/26) | **Done:** `OWNED_SKILL_DIR` + realpath package bind; strip/force `--expected-source`; simple-ref argv vs request-file lanes; no free-text shell splice. |
