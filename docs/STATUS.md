...
| Uninstall/verify transactional consistency (#22) | [Issue #22](https://github.com/ImL1s/resume-skills/issues/22) | **Done on branch** `program/issue-22-uninstall-verify-txn`: journaled uninstall with stage snapshots + recover; POSIX locked verify; crash-matrix tests. Residual: Windows exclusive lock remains #29. |
