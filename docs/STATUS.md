...
| Installed runner matrix | **Ubuntu hard gate 306/306** (**17×18**, derived from registries); **Windows** focused product-install smoke only (3 hosts) — **not** 306/306 on Windows; published `0.3.4` remains historical **9×9=81** |
