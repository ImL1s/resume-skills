...
|---|---|---|
| Current checkout gates | pass | **785 tests in PR #218 validation CI** ([run 30758747880](https://github.com/ImL1s/resume-skills/actions/runs/30758747880), Ubuntu/Python 3.12, validation head `43f5e93`) + **306/306** registry-derived installed-runner; native Windows passed the Phase‑1 lock primitive and read-only/platform gates while mutating installed-runner remained intentionally skipped; distribution identity smoke passed. The prior **944 local** snapshot at `18fe4ca` is historical. |
