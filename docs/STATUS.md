...
| Shared `stable_scan_lines` (#10) | [Issue #10](https://github.com/ImL1s/resume-skills/issues/10) + PR #49 | Foundation + adapters on main; **collect-free verified spool yield** on branch `program/issue-10-collect-free-scan-yield`. Claude private graph retained. Residual: zstd whole-decompress (#8). |
