...
| OpenCode oversized live WAL (Issue #263 Phase 1) | **Implemented locally; review/merge pending:** honest `E_SQLITE_LIVE_WAL` + bounded retry accounting + independent provider fallback warning. **Phase 1 only:** macOS/APFS live COW snapshot is unimplemented and unproven; issue closure remains blocked on Phase 2 proof. |
