...
La prueba local de hosts superó 8/8 invocaciones de CLI y 7/7 instalaciones nativas de plugin／extension admitidas. La interacción con selectores visuales y la publicación en marketplaces públicos siguen siendo comprobaciones separadas no ejecutadas.
