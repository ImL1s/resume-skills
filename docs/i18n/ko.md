<!-- portable-resume-i18n: ko v0.3.0 -->
...
선택적 웹 검색과 Context7 설정은 [네트워크 통합](../network-integrations.md)에 있습니다. 리더 자체에는 네트워크 경로가 없습니다. 검증된 주장과 실행되지 않은 UI／release 게이트는 [프로젝트 상태](../STATUS.md)를 참조하세요.
