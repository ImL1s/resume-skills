...
**현재 공개 릴리스:** [`0.3.2`](https://github.com/ImL1s/resume-skills/releases/tag/v0.3.2)
...
현재 로컬 host 스모크에서는 8/8 CLI 호출이 통과했고, 정확한 `0.3.2` 패키지는 지원되는 7/7 네이티브 plugin／extension 설치를 모두 통과했습니다. 시각적 picker 상호작용과 공개 marketplace 게시는 별도의 미실행 항목입니다.
