...
Current local host smoke passed 8/8 CLI invocations and 7/7 supported native
plugin/extension installations. Visual picker interaction and public
marketplace publication remain separate not-run claims.
