...
Локальная проверка host успешно выполнила 8/8 вызовов CLI и 7/7 установок поддерживаемых нативных plugin／extension. Взаимодействие с визуальным picker и публикация в открытых marketplace остаются отдельными невыполненными проверками.
