...
<p align="center">
  <em>Offline, local-only context migration · 11 sources × 11 hosts (derived from registries) · inert handoff, not live restore</em>
</p>
...
· [PyPI](https://pypi.org/project/portable-resume/0.3.4/) · **121/121** packaging and
installed-runner cells on current `main` (11 sources × 11 destinations, including
Pi + OpenClaw + goose filesystem install; published `0.3.4` remains historical 81).
...
Destination profiles: Claude Code, Codex, Cursor, OpenCode, Antigravity, Grok Build, Qwen Code, Kimi Code CLI, Pi agent, OpenClaw, and goose.
...
```bash
# Inspect capabilities and the registry-derived matrix (currently 11×11)
