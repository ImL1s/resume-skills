...
<p align="center">
  <em>Offline, local-only context migration · 10 sources × 10 hosts (derived from registries) · inert handoff, not live restore</em>
</p>
...
· [PyPI](https://pypi.org/project/portable-resume/0.3.4/) · **100/100** packaging and
installed-runner cells on current `main` (10 sources × 10 destinations, including
Pi + OpenClaw filesystem install; published `0.3.4` remains historical 81).
...
Destination profiles: Claude Code, Codex, Cursor, OpenCode, Antigravity, Grok Build, Qwen Code, Kimi Code CLI, Pi agent, and OpenClaw.
...
```bash
# Inspect capabilities and the registry-derived matrix (currently 10×10)
