...
**Current release:** [`0.4.1`](https://github.com/ImL1s/resume-skills/releases/tag/v0.4.1)
· [PyPI](https://pypi.org/project/portable-resume/0.4.1/) · **306/306** packaging and
...
smoke (3 hosts), **not** full 306/306 on Windows. Published `v0.4.0` remains historical; published `v0.3.4` remains historical 81.
...
**Release candidate on `main`:** exact package version `0.4.1` (tag `v0.4.1`).
