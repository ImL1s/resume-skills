...
<p align="center">
  <em>Offline, local-only context migration · 12 sources × 12 hosts (derived from registries) · inert handoff, not live restore</em>
</p>
...
· [PyPI](https://pypi.org/project/portable-resume/0.3.4/) · **144/144** packaging and
installed-runner cells on current `main` (12 sources × 12 destinations, including
Pi + OpenClaw + goose + Crush filesystem install; published `0.3.4` remains historical 81).
...
Destination profiles: Claude Code, Codex, Cursor, OpenCode, Antigravity, Grok Build, Qwen Code, Kimi Code CLI, Pi agent, OpenClaw, goose, and Crush.
...
```bash
# Inspect capabilities and the registry-derived matrix (currently 12×12)
